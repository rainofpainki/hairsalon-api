...
COMMENT ON COLUMN "PROCEDURE".PROCEDURE_MINUTES IS '시술 소요시간(분)'/
...
, RESERVATION_START_TIME DATE NOT NULL
, RESERVATION_END_TIME DATE NOT NULL
, RESERVATION_MINUTES NUMBER NOT NULL
, USER_ID NUMBER NOT NULL
, SHOP_ID NUMBER NOT NULL
, STYLIST_ID NUMBER NOT NULL
, PROCEDURE_ID NUMBER NOT NULL
, PRICE NUMBER
, RESERVATION_SHOP_NAME VARCHAR2(50) NOT NULL
, RESERVATION_STYLIST_NAME VARCHAR2(20) NOT NULL
, RESERVATION_PROCEDURE_NAME VARCHAR2(50) NOT NULL
...
COMMENT ON COLUMN RESERVATION.RESERVATION_START_TIME IS '예약 시작 시간'/
COMMENT ON COLUMN RESERVATION.RESERVATION_END_TIME IS '예약 종료 시간'/
COMMENT ON COLUMN RESERVATION.RESERVATION_MINUTES IS '시술 소요시간(분)'/
COMMENT ON COLUMN RESERVATION.RESERVATION_SHOP_NAME IS '예약 헤어샵 이름'/
COMMENT ON COLUMN RESERVATION.RESERVATION_STYLIST_NAME IS '예약 스타일리스트 이름'/
COMMENT ON COLUMN RESERVATION.RESERVATION_PROCEDURE_NAME IS '예약 시술 이름'/
